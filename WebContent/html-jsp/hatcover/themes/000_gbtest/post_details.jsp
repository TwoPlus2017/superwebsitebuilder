                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 posts-list">
                    <div class="post" id="post-1">
                        ...
                        <div class="data-post">
                            ...
                            <p>by <span class="post-author"><a href="#">deximjobs</a></span></p>
                        ...
                        <div class="comment-section">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 zero-padding-right">
                                <img src="assets/images/job-admin.png" class="img-responsive" alt="" />
                            </div>
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 no-padding">
                                <div class="view-comments">
                                    <p><strong>Martin</strong>
                                        <br />October 21, 2016 at 1:32 pm </p>
                                    ...
                                    <form name="contact_us">
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-4 col-lg-push-2 col-md-4 col-md-push-2 col-sm-4 col-sm-push-2 col-xs-12">
                                                <input type="submit" name="submit" id="post-comments" value="Post a comment">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="blog-sidebar">
                    <div class="widget">
                        ...
                        <div class="recent-post">
                            <ul>
                                <li><a href="blog-post.html">The Best (and Worst) Canadian Merchant Account Providers</a></li>
                                <li><a href="blog-post.html">Do you have a job that the average person doesn’t even know exists?</a></li>
                                <li><a href="blog-post.html">The Best (and Worst) Canadian Merchant Account Providers</a></li>
                                <li><a href="blog-post.html">Do you have a job that the average person doesn’t even know exists?</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="widget">
                        ...
                        <div class="post-list categories">
                            <ul>
                                ...
                                <li><a href="#">RSS WordPress.org</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
